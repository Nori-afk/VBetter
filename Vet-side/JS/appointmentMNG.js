				...
				<tr>
					...
					<td>
						<div class="action-buttons">
							<button type="button" title="View" data-action="view" data-id="${item.id}"><img src="/Vet-side/Images/eye.png" alt="View"></button>
							<button type="button" title="Delete" data-action="delete" data-id="${item.id}"><img src="/Vet-side/Images/trash.png" alt="Delete"></button>
						</div>
					</td>
				</tr>
			`;
...
function detailsModalTemplate(appointment) {
	...
	return `
		...
		<img src="/Vet-side/Images/appticon.png" alt="Patient photo" class="patient-photo">
		...
		<div class="details-top">
			...
			<div class="detail-actions">
				<button class="btn btn-primary" type="button" data-modal-action="open-complete"><img src="/Vet-side/Images/completed.png" alt="Complete">Mark as Completed</button>
				<button class="btn btn-outline" type="button" data-modal-action="open-reschedule"><img src="/Vet-side/Images/reschedule.png" alt="Reschedule">Reschedule</button>
				<button class="btn btn-soft-danger" type="button" data-modal-action="open-cancel"><img src="/Vet-side/Images/cancel.png" alt="Cancel">Cancel Appointment</button>
			</div>
		</div>
		<div class="info-grid">
